<template>
    ...
    <el-carousel-item  v-for="item in lunbolist" :key="item.imageUrl">
    ...
    <div class="recommend">
      ...
      <div class="items">
        <div class="item"  v-for="item in recommendList" :key="item">
   ...
   <div class="items">
   <div class="item" v-for="(item) in  newmusiclist" :key='item.id' @click="playmusic(item.id)">
   <div class="img-wrap">
   <img :src="item.picUrl" alt="">
   <span class="iconfont icon-play"></span>
   </div>
   ...
   <div class="singer">{{item.song.name}}</div>
   </div>
   </div>
   </div>
   </div>
  ...
  <div class="img-wrap" @click="tomvde(item.id)">
  <img :src="item.picUrl" alt="">
  <span class="iconfont icon-play"></span>
  <div class="num-wrap">
